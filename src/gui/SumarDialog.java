 ...
 * @author Usuario
 */
class SumarDialog extends JDialog{
    ...
    public SumarDialog(JFrame owner, String titulo) {
    ...
    private JPanel crearPnlPoli1() {
        ...
        this.btnAgregar1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                Monomio m = new Monomio(Integer.valueOf(SumarDialog.this.txtCoef1.getText()),Integer.valueOf(SumarDialog.this.txtExp1.getText()));
                SumarDialog.this.controlador.agregarPoli1(m);
                SumarDialog.this.lblPoli1.setText(SumarDialog.this.controlador.getPoli1().imprimirPolinomio());
            }
        });
    ...
    private JPanel crearPnlSumar() {
        ...
        this.btnSumar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                try {
                    SumarDialog.this.lblResultado.setText(SumarDialog.this.controlador.sumar().imprimirPolinomio());
                } catch (PolinomioFaltanteException ex) {
                    JOptionPane.showMessageDialog(SumarDialog.this,"Polinomio faltante");
                }
            }
        });
